...
namespace SLMPLauncher
{
    public static class FuncClear
    {
        ...
        {
            FuncParser.iniWrite(FormMain.pathLauncherINI, "ENB", "NightBrightness", "0");
